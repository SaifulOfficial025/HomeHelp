...
function DocumentationScore() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow p-4 sm:p-7 border border-slate-100 w-full max-w-full mx-auto">
      <div className="text-xl sm:text-2xl font-extrabold text-slate-800 mb-2">
        Documentation Score
      </div>
      <div className="text-3xl sm:text-4xl text-[#18aa99] mb-1 text-center">
        {totalScore}/{maxScore}
      </div>
      <div className="text-slate-500 text-xs sm:text-sm mb-5 text-center">
