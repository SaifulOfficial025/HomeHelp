...
import { fetchQRCode } from "../../Redux/QR";
...
function QRPage() {
    ...
    const loadQRData = async () => {
      try {
        ...
        if (properties && properties.length > 0) {
          ...
          const slug = firstProperty.slug;

          // Fetch QR code data using the slug
          const qrResponse = await fetchQRCode(slug);
          setQrData(qrResponse);

          // Convert base64 QR code to image URL
          if (qrResponse.qr_code) {
            const qrImageDataUrl = `data:image/png;base64,${qrResponse.qr_code}`;
  ...
  const propertyTitle = qrData?.property_name || "Loading...";
  const publicUrl = qrData?.property_url || "";
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        ...
        {loading ? (
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              <QRandPropertyLink qrSrc={qrImageUrl} propertyLink={publicUrl} />
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow p-6">
                ...
                <p className="text-xs text-slate-400 mt-3">
                  Share this link or QR code with potential buyers. They can
                  scan to preview and unlock full documentation for $50.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow p-6">
                ...
                <ol className="list-none text-sm text-slate-600 space-y-4">
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <div className="mt-1.5">
                      They see a locked preview of property photos and report
                      list
                    </div>
                  </li>
